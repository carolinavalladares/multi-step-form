...
export default function StepFour() {
  const { plan, billingPeriod, addOns, setStep } = useFormInfo();
  ...
  return (
    <form id="step-4">
      <h1 className="text-xl font-bold text-marine-blue mb-1">Finishing up</h1>
              ...
              {addOns.map((item, index) => {
                return (
                  <div
                    ...
                    key={index}
                  >
                    <span className="text-cool-gray text-sm ">{item.name}</span>
